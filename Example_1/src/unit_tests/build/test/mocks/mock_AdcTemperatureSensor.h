...
#ifndef _MOCK_ADCTEMPERATURESENSOR_H
#define _MOCK_ADCTEMPERATURESENSOR_H
...
void mock_AdcTemperatureSensor_Init(void);
void mock_AdcTemperatureSensor_Destroy(void);
void mock_AdcTemperatureSensor_Verify(void);
